...
public class LobbySocketController {
    ...
    private GameState initializeGame(String gameId, Lobby lobby) {
        ...
        if (!detectives.isEmpty()) {
            ...
            messaging.convertAndSend("/topic/game/" + gameId, GameMapper.mapToGameUpdate(gameId, game.getRoundManager().getPlayerPositions(), game.getCurrentPlayerName(),null));//positionen
